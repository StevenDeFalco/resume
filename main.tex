...
\section{Experience}
  \resumeItemListStart
    ...
    \resumeCompanyHeader{Quant}{New York, NY}
    \resumeJobTitle{Solutions Engineer}{November 2025 - Present}
    \resumeBulletStart
      \resumeBullet
      {Partner with sales and enterprise clients to define requirements and rapidly build full-stack MVPs, agentic AI pipelines, and executive-level demos (Python/JS, ElevenLabs, React, MongoDB), translating business needs into technically feasible solutions in a fast-paced pre-sales environment.}
    \resumeBulletEnd
    ...
    \resumeJobTitle{AI Solutions Engineer}{May 2025 - October 2025}
    \resumeBulletStart
      \resumeBullet
    ...
    \resumeBulletStart
      \resumeBullet
      {Automated migration of 1,000+ LMS courses using Python (Pandas, Playwright), demonstrating scalable automation.}
      \resumeBullet
...
\section{Skills and Technologies}
  \resumeItemListStart
    \item{
      ...
      \\
      \textbf{Technologies}{: Azure, Azure Functions, Azure AI Foundry, OpenAI API, LlamaIndex, LLMs, RAG, MCP, React, Node.js/Express, MongoDB, ElevenLabs (STT/TTS), Git, CI/CD, Linux, Prompt Engineering, LaTeX}
    }
  \resumeItemListEnd
