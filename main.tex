...
% New command for job titles within the same company
...
% New command for subsequent job titles with tighter spacing
...
% New command for company header with multiple job titles
