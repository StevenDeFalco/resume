  ...
  \resumeItemListStart
    \vspace{-1pt}\item
      \begin{tabular*}{0.97\textwidth}{l@{\extracolsep{\fill}}r}
        ...
        \textit{\small MBA \& MS in Applied Artificial Intelligence} & \textit{\small January 2025 -- Present} \\
...
\section{Experience}
  \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Computer Science Course Assistant}{September 2022 - May 2023}
      \resumeBulletStart
        \resumeBullet
...
\section{Projects} 
  \resumeItemListStart
    ...
    {Built and deployed an autonomous X/Twitter bot on AWS Lightsail that posts same-day MLB game predictions using a custom LightGBM model trained on 5 years of historical data with fully automated data pipelines, achieving 66\% predictive accuracy on a 1,100-game backtest.}
