...
\section{Skills and Technologies}
  \resumeItemListStart
    \item{
      ...
      \\
      \textbf{Technologies}{: Azure, Azure AI Search, Azure Functions, OpenAI API, LlamaIndex/LlamaParse, LLMs, MCPs, Ionic/React (PWA), Git, CI/CD, Linux, Prompt Engineering, LaTeX}
    }
  \resumeItemListEnd
